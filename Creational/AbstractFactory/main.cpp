...
/**
 * @brief Each product of a product family should have a base interface.
 * All variants of the product must implement this interface.
 * All products can interact with each other, but proper interaction is
...
public:
    std::string UsefulFunctionB() const override
    {
        return "The resulft of the product B2.";
    }
 ...
 * related by a high-level concept.
 ...
 * variant are incompatible with products of another.
 * 
 */
...
/**
 * @brief Concrete Factories produce a family of products that belong to a
...
/**
 * @brief Client code works with factories and products only through abstract
